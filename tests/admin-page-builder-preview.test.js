...
describe("admin page-builder editor and preview renderers", () => {
  ...
  it("renders grouped theme sections for presets, palette, and panel controls", () => {
    ...
    expect(wrapper.querySelector('.pb-theme-color-text[data-key="primary"]')?.getAttribute("value")).toBe("#112233");
    expect(wrapper.querySelector('.pb-panel-bg-path[data-panel="left"]')?.getAttribute("value")).toBe("assets/uploads/left.png");
    expect(wrapper.querySelector('.pb-panel-gap[data-panel="left"]')?.getAttribute("value")).toBe("20");
  });
