...
export const el = {
  ...
  pbNoFallback: document.getElementById('pbNoFallback'),
  pbPublished: document.getElementById('pbPublished'),
  ...
  pbViewEdit: document.getElementById('pbViewEdit'),
  pbViewPreview: document.getElementById('pbViewPreview'),
