...
export const el = {
  ...
  pbBuilderToolbar: document.getElementById('pbBuilderToolbar'),
  pbBuilderSidePanel: document.getElementById('pbBuilderSidePanel'),
  pbCanvasViewport: document.getElementById('pbCanvasViewport'),
  pbCanvasOverlay: document.getElementById('pbCanvasOverlay'),
  pbExitBuilder: document.getElementById('pbExitBuilder'),
  ...
  pbHistory: document.getElementById('pbHistory'),
  pbHistoryDialog: document.getElementById('pbHistoryDialog'),
  pbHistoryDialogTitle: document.getElementById('pbHistoryDialogTitle'),
  pbHistoryDialogBody: document.getElementById('pbHistoryDialogBody'),
  pbHistoryDialogClose: document.getElementById('pbHistoryDialogClose'),
  pbRecoveryStatus: document.getElementById('pbRecoveryStatus'),
  ...
  pbLayerTree: document.getElementById('pbLayerTree'),
